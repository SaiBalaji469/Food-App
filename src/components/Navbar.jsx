...
import {AiOutlineMenu, AiOutlineSearch, AiOutlineClose, AiFillTag, AiFillFolder} from "react-icons/ai"
        ...
        <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
            ...
            <nav>
                <ul className='flex flex-col p-4 text-gray-800'>
                    ...
                    size={25} className='mr-4'/> Promations</li>
                    <li className='text-xl py-4 flex'><BsFillCartFill 
                    size={25} className='mr-4'/> Best Ones</li>
